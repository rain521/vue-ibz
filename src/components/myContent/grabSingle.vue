      ...
      <li v-for="item in list">
        <a :href="item.link">
          ...
          <div class="clearfix p10">
            ...
            <button type="button" class="ibz-button3 fr">查看订单</button>
          </div>
        </a>
      </li>
    </ul>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        list: [
          {link: '#/details', img: require("../../assets/image/ibz2.png"), product: '出口纸箱', productSize: '100*100', productionPhase: '24天', shippingAddress: '上海市徐汇区'},
          {link: '#/details', img: require("../../assets/image/ibz2.png"), product: '出口纸箱', productSize: '100*100', productionPhase: '24天', shippingAddress: '上海市徐汇区'},
          {link: '#/details', img: require("../../assets/image/ibz2.png"), product: '出口纸箱', productSize: '100*100', productionPhase: '24天', shippingAddress: '上海市徐汇区'},
          {link: '#/details', img: require("../../assets/image/ibz2.png"), product: '出口纸箱', productSize: '100*100', productionPhase: '24天', shippingAddress: '上海市徐汇区'},
          {link: '#/details', img: require("../../assets/image/ibz2.png"), product: '出口纸箱', productSize: '100*100', productionPhase: '24天', shippingAddress: '上海市徐汇区'},
